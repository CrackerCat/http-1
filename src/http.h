...
extern HTTP_EXPORT size_t http_body_readall(void *data, size_t size,
                                            size_t count,
                                            struct http_body_t *body);
...
extern HTTP_EXPORT void http_add_header(struct http_request_t *req,
                                        const char *header);
extern HTTP_EXPORT void http_add_header2(struct http_request_t *req,
                                         const char *name, const char *value);
extern HTTP_EXPORT void
http_add_oauth2header(struct http_request_t *req,
...
extern HTTP_EXPORT char *http_get_header(struct http_response_t *resp,
                                         const char *header);

extern HTTP_EXPORT const char *http_get(struct http_request_t *req,
                                        const char *url);
extern HTTP_EXPORT const char *http_post(struct http_request_t *req,
                                         const char *url,
                                         const char *content_type,
                                         const char *content);
extern HTTP_EXPORT const char *
http_put(struct http_request_t *req, const char *url, const char *content_type);
extern HTTP_EXPORT const char *http_delete(struct http_request_t *req,
                                           const char *url);
extern HTTP_EXPORT const char *http_do(struct http_request_t *req,
                                       struct http_response_t *resp);

extern HTTP_EXPORT void http_cleanup(struct http_request_t *req,
                                     struct http_response_t *resp);
